...
geneTrack <- AnnotationTrack(
                ...
                rotation.item = 90, stacking="squish", showFeatureNames=TRUE)
...
geneTrack <- AnnotationTrack(
                genome = "ZalCal", chromosome = chr, name = "Genes",
                start = annotations$Start, #c(50, 180, 260, 460, 860, 1240),
                end = annotations$Stop, #c(15, 20, 40, 100, 200, 20),
                strand = annotations$Strand, #c("-","-","+","+","-","+"),
                feature = annotations$Name, #c("gene1-","gene2-","gene3+","gene4+","gene5-","gene6+"),
                fill = Yregion_colors[annotations$Yregion], # fill = c("#3a3a99","#3a3a99","#63a763","#63a763","#3a3a99","#bfc237"),
                col = Yregion_colors[annotations$Yregion],
                rotation.item = 90, stacking="pack")
